...
def render_rules(data: dict) -> str:
    ...
    lines = [
        ...
        *(
        ...
        "- Every authored text run maps to one of the five locale levels; the slide's sole core proof numeral may use headline size, while secondary proof numerals use subheadline size. They do not create a sixth level.",
